...
- **Uma prévia antes de uma gravação.** Nada é escrito antes de o
  {profissional} ver o que vai entrar.
...
fora, e só entra se o {profissional} disser o nome dela. Automático é para
...
inteira desde 2019, salvo se o {profissional} pedir. O padrão é **doze meses**,
...
{profissional} instalou e uma que leu o telefone dele sem avisar.
...
**37 conversas na lista · 12 lidas · 25 não abertas · 8 {pessoas} entraram.**
