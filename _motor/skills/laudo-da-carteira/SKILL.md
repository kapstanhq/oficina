...
description: >-
  ...
  o {profissional} disser — a carteira está confiável? · dá uma conferida no que
  ...
  arruma nada: quem arruma é /{plugin}:organizar-carteira, e quem cobra o que
...
1. Leia `~/carteira/INDICE.md`. Não existe: uma linha dizendo que não há
   carteira para conferir, e `/{plugin}:comecar`. Não invente carteira vazia.
...
- {pasta-itens}/{exemplo-item-arquivo} · campo `preço` = 720.000, sem `←`
  → confirme a origem ou marque `?` · /{plugin}:organizar-carteira
- {pasta-pessoas}/{exemplo-pessoa-arquivo} · campo `telefone`, sem `←`
  → veio de onde? · /{plugin}:organizar-carteira

## Vencido — 1

- {pasta-itens}/{exemplo-item-arquivo} · `preço` apurado em 2026-06-02, há 99 dias
...
- {pasta-pessoas}/{exemplo-pessoa-arquivo} · 186 linhas, teto 120
  → o histórico vai para `_bruto/` · /{plugin}:organizar-carteira
