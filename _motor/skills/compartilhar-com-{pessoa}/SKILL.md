...
compatibility: >-
  ...
  o {profissional} compartilhar à mão. Nunca concede escrita, e nunca
...
O {profissional} responde a mesma pergunta toda semana: **"e aí, como está?"**.
...
```
arquivo     vistas/{exemplo-pessoa-arquivo}
...
Se o {profissional} quiser avisar, ela escreve a mensagem — três linhas, com o
...
transferiria para o {profissional} uma decisão que o contrato já tomou.
...
````markdown
# A vista de {exemplo-pessoa} — 2026-09-09
...
{pessoa} para outro — o erro mais fácil de cometer e o mais caro de descobrir.
...
para sempre, e o Drive não avisa. Se o {profissional} pedir, ela diz isso em uma
