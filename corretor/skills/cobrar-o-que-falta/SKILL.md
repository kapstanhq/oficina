...
description: >-
  ...
  texto e o destinatário na tela antes. Use quando o corretor disser — o
  ...
  /corretor:retomar-contato, nem para a lista do dia, que é
  /corretor:o-que-fazer-hoje.
license: MIT
compatibility: >-
  Precisa da carteira; sem ela diz isso em uma linha e manda rodar
  /corretor:comecar. Sem o conector ela escreve as cobranças para copiar e quem
  manda é o corretor — o trabalho sai inteiro do mesmo jeito. Com o
...
Isso é o oposto do resto do pack. `/corretor:o-que-fazer-hoje` lista o que o
corretor tem que fazer; esta lista o que ele **não pode fazer** porque está
...
- **Não é retomada.** Quem sumiu do funil sem dever nada é
  `/corretor:retomar-contato`. Aqui a pessoa **deve uma coisa concreta**, e a
...
coisa**. O corretor escolhe quem recebe.
...
2. **Os `?` com dono** nos arquivos de `imoveis/` e `clientes/`. Um
...
Uma pendência é `a matrícula do V-071 (casa 3 dorm, Azenha), pedida ao proprietário em 2026-08-13` — quem, o quê, desde quando.
...
- **Cobrado duas vezes sem resposta.** Passa a ser conversa do corretor,
...
A ordem se explica em uma linha por item — o corretor precisa saber por que
...
corretor copia e cola. Nada de moldura desenhada.
...
**1 · a matrícula do V-071 (casa 3 dorm, Azenha), pedida ao proprietário em 2026-08-13**
...
## Fora da fila
- C-017 (Joana Ribeiro) · cobrado em 2026-09-07, há 2 dias — espere até o dia 14
- C-017 (Joana Ribeiro) · já respondeu em 2026-09-05; tirei a pendência

## Guardei
- ~/carteira/clientes/C-017-joana-ribeiro.md — a tentativa de hoje
- ~/carteira/hoje.md — as pendências que saíram da fila

## Falta saber
- o prazo combinado para a matrícula do V-071 (casa 3 dorm, Azenha), pedida ao proprietário em 2026-08-13 — usei o padrão de 7 dias
````
...
quem escreve é o corretor, que sabe o que foi combinado.

**Ela não manda para quem nunca escreveu.** Contrato §7.1: a primeira mensagem
para um número novo sai do celular do corretor. Aqui isso quase nunca
...
conversa e manda `/corretor:organizar-carteira`, que é quem extrai fato com
