...
- imoveis/V-071-casa-3d-azenha.md · campo `preço` = 720.000, sem `←`
  → confirme a origem ou marque `?` · /corretor:organizar-carteira
- clientes/C-017-joana-ribeiro.md · campo `telefone`, sem `←`
  → veio de onde? · /corretor:organizar-carteira

## Vencido — 1

- imoveis/V-071-casa-3d-azenha.md · `preço` apurado em 2026-06-02, há 99 dias
  → pergunte de novo antes de usar em qualquer texto

## Órfãos — 3

- `funil.md` cita V-071 (casa 3 dorm, Azenha) e o arquivo não existe
- clientes/C-017-joana-ribeiro.md não está no `_indice.md` da pasta
- `hoje.md` cita um id sem apelido, três vezes

## Acima do teto — 1

- clientes/C-017-joana-ribeiro.md · 186 linhas, teto 120
  → o histórico vai para `_bruto/` · /corretor:organizar-carteira

## Os `?` mais velhos — 5

- imoveis/V-071-casa-3d-azenha.md · há 41 dias · o que falta está na linha `←`
