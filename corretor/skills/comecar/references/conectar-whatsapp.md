...
elevação, e o corretor pode não ter. A saída não precisa de nada disso: um
...
transcrita, e o que o cliente combinou falando entra na carteira como entra o
que ele escreveu.
...
CRECI entre elas — com a correção dos erros que ela já cometeu.
...
no diretório da ponte, onde entram os nomes dos clientes e dos lugares que
