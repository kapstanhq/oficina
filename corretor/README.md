...
|---|---|
| **WhatsApp não conecta sozinho** | O padrão é você exportar ou colar a conversa, e isso funciona em qualquer lugar. Em programa que roda no seu computador dá para ligar um conector — não é da Meta, é instalação à parte de uns quinze minutos. Com ele, ela **lê** as suas conversas — inclusive o que foi dito nos **áudios**, transcritos no seu próprio computador, sem que nada saia dele — e **manda uma por vez**: quem vai receber e o texto inteiro aparecem na sua tela antes, e nada sai sem você mandar sair. Lote e lista de transmissão não existem em lugar nenhum do pack. |
...
| **Ela não manda áudio nem arquivo** | Pelo conector sai texto, e só para uma pessoa. Foto, áudio, documento e grupo saem do seu WhatsApp, na mão. Ler áudio ela lê, com a transcrição instalada — o que ela não faz é mandar. |
