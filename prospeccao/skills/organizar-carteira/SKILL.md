...
1. **O contrato, por seção.** Ele é a lei do pack, e ler o documento inteiro
   ...
   formatos literais — `04-4-arquivo-de-conta.md` é o gabarito da ficha que a
...
`contas/` e `contatos/` o dava como não lido em toda execução.
...
é /prospeccao:<skill>` —, ele não é trabalho desta: vira uma linha só em
