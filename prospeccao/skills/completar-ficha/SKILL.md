...
description: >-
  Procura o que falta em uma conta da carteira — os campos do cabeçalho que estão
...
ele entrou. Alguns decidem se ele serve ao prospector, e ele abre a ficha,
...
4.4  o arquivo da conta             4.7  o bruto
4.6  os dois índices                 10   como uma skill começa e termina
```

Os arquivos: `02-0-id-e-apelido.md`, `03-0-as-tres-regras.md`,
`04-4-arquivo-de-conta.md`, `04-6-os-dois-indices.md`, `04-7-o-bruto.md` e `10-0-comeca-e-termina.md`. E
...
Conta também o campo que o `04-4-arquivo-de-conta.md` tem e o arquivo não: registro
...
`04-4-arquivo-de-conta.md` escreve um caminho próprio**: esse segue o caminho de
...
- se a fonte diz que o registro **saiu do ar** ou fechou, isso é fato: o campo
  ...
  `/prospeccao:organizar-carteira` — ela não aposenta
...
- a linha do `funil.md` e o `_indice.md` que repetem um campo que mudou mudam
  juntos (Regra 1: o arquivo da conta é o dono, as vistas acompanham)
...
## Guardei
- ~/carteira/<arquivo da conta> — os campos e o histórico
- ~/carteira/_bruto/<arquivo> — a página que li

## Falta saber
- <o campo que só o prospector ou a organização respondem, e a quem perguntar>
````
...
prospector conferir cada fonte antes de o campo virar verdade na carteira.
