...
description: >-
  ...
  contatos e contas com procedência em cada campo. Mostra o que vai entrar
  ...
  mesmo arquivo. Use no primeiro dia, depois de /prospeccao:comecar, e quando o
  prospector disser — está tudo no meu WhatsApp · minha carteira está vazia
  ...
  entrou é /prospeccao:organizar-carteira, e quem confere se ficou bom é
  /prospeccao:laudo-da-carteira.
license: MIT
compatibility: >-
  Precisa da carteira montada; sem ela manda rodar /prospeccao:comecar primeiro.
...
quem é cada contato, o que foi combinado, quanto foi cobrado, quem prometeu
...
- **Uma prévia antes de uma gravação.** Nada é escrito antes de o
  prospector ver o que vai entrar.
...
1. `~/carteira/INDICE.md`. Não existe: **pare** e mande rodar
   `/prospeccao:comecar`. Esta skill enche uma carteira; ela não monta uma.
...
fora, e só entra se o prospector disser o nome dela. Automático é para
...
**Entra** — a conversa cujo nome bate com um contato que já está na carteira; a
que tem, no que já se sabe dela, palavra do ofício; a que o prospector
nomear.
...
inteira desde 2019, salvo se o prospector pedir. O padrão é **doze meses**,
e ela declara o padrão que usou.

Ao ler, valem as regras do contrato §7 sem nenhuma mudança: quem é o
prospector na conversa, as datas em dd/mm/aaaa, e **o que não se lê não se
...
prospector vai reparar na diferença, e ela tem explicação.
...
- que contas foram MENCIONADOS mas não entram (§7 do contrato: conta sem link
  nem ficha não entra)
...
- **Se der errado no meio, o que já entrou fica.** Ela relata onde parou e o que
  ...
  faz o prospector perder uma hora e a confiança junto.
...
que responde à única pergunta que o prospector vai fazer depois:
...
prospector instalou e uma que leu o telefone dele sem avisar.
...
- P-017 (Carla Menezes) — entrou agora · telefone, o que procura, última conversa em 12/08
- … uma linha por pessoa, com os campos e nada do texto

## Mencionaram contas que não entraram — 3

- uma conversa cita uma conta que não está na carteira e não tem link
...
- ~/carteira/contatos/ — 8 criados, 4 atualizados
...
**Ela não cria conta que a conversa menciona.** Sem link nem ficha, ele não
...
para a carteira. Se o prospector quiser que algo saia da carteira depois,
quem tira é ele ou `/prospeccao:organizar-carteira` — e o `_bruto/` tem prazo de
