...
1. **O contrato, por seção.** Ele é a lei do pack, e ler o documento inteiro
   ...
   `04-5-arquivo-de-contato.md`, `04-6-os-dois-indices.md` e `04-7-o-bruto.md` (os
   formatos literais — `04-4-arquivo-de-vaga.md` é o gabarito da ficha que a
...
procure   o nome do bruto: 2026-09-11-whatsapp-helena.md
          em: ~/busca/vagas/  ~/busca/contatos/  ~/busca/arquivo-morto/
              e os outros donos: os arquivos da raiz da busca e as pastas que
...
Um `Grep` por bruto são centenas de chamadas: numa busca de 180 brutos, a
...
arquivo da raiz ou de outra pasta da busca é citado lá, e procurá-lo só em
`vagas/` e `contatos/` o dava como não lido em toda execução.
...
é /vagas:<skill>` —, ele não é trabalho desta: vira uma linha só em
